        ...
        <div className="w-full max-w-sm space-y-3 my-auto">
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="pt-4 sm:pt-5 pb-4 sm:pb-5">
                ...
                <div className="space-y-1.5">
                  ...
                  {password && (
                    <div className="grid grid-cols-2 gap-1 text-xs">
                      {["8+ chars", "Uppercase", "Lowercase", "Number"].map((rule, index) => {
                        const fullRule = ["At least 8 characters", "One uppercase letter", "One lowercase letter", "One number"][index];
                        const isValid = !passwordErrors.includes(fullRule);
                        return (
                          <div key={rule} className={`flex items-center space-x-1 ${isValid ? "text-green-600" : "text-muted-foreground"}`}>
                            {isValid ? (
              ...
              <div className="text-center">
                <Link href="/login">
                  <Button variant="outline" className="w-full h-9 sm:h-10 font-medium text-sm sm:text-base">
                    Sign in instead
                  </Button>
                </Link>
              </div>
          ...
          <div className="space-y-6 text-center max-w-sm">
            ...
            <div className="grid grid-cols-2 gap-4 text-center">
              ...
              <div className="space-y-1">
                ...
                <div className="text-xs text-muted-foreground">Money tracked</div>
              </div>
              <div className="space-y-1">
